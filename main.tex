...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/image41.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.94\linewidth]{images/image7.png} % ganti dengan gambar hasil render mermaid kamu
...
\begin{figure}[!htbp]
    \centering
    \includesvg[width=0.92\linewidth]{images/image8.png}   
